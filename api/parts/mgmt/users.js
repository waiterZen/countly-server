...
(function (usersApi) {
    ...
    usersApi.getAllUsers = function (params) {
        ...
        common.db.collection('members').find({}, { password: 0, appSortList: 0 }).toArray(function (err, members) {
            ...
            common.db.collection('failed_logins').find({}).toArray(function (err, failedLogins) {
                if (err) {
                    common.returnOutput(params, {});
                    return false;
                }
    ...
    usersApi.resetTimeBan = function(params){
        ...
        common.db.collection('failed_logins').remove({_id:params.qstring.username}, (err, res) => {
            if (err) {
